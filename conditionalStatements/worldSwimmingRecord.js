...
function worldSwimmingRecord(input){
    ...
    let timeInSecToSwim=distanceInMeters*timeInSecPerOneMeter;
    let resistanceSec=Math.floor(distanceInMeters/15)*12.5;

    let totalTime=timeInSecToSwim+resistanceSec;
